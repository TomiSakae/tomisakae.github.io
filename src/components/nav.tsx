...
const Nav = () => {
    ...
    useEffect(() => {
        if (typeof window !== 'undefined') {
            ...
            if (storedStatuses.length < 22) {
                const initialStatuses = [...storedStatuses, ...new Array(22 - storedStatuses.length).fill(0)];
            ...
            if (storedJobs.length < 12) {
                const initialJobs = [...storedJobs, ...new Array(12 - storedJobs.length).fill(-1)];
