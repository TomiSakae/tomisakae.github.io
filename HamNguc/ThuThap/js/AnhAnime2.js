$(document).ready(function () {
    ...
    mau_toi_da = 120; // Lưu mức máu ban đầu để tính toán tỉ lệ
        ...
        if (thong_tin_dau_game_cleared && mau_dau_game_cleared) {
            ...
            $nhan_anh.click(function () {
                if (mau_ban_dau > 0) {
                    ...
                    if (mau_ban_dau <= 60 && kt_kich_hoat == false) {
                        KyNangBaoVe1();
                        kt_kich_hoat = true;
                    }
                    if (mau_ban_dau < 0) {
...
function KyNangBaoVe1() {
    thong_tin = `
    <div class="pb-2 mb-2">
        <h6>Kích hoạt kỹ năng bảo vệ!</h6>
        <p>Giảm thời gian hiện tại xuống thêm 25 giây.</p>
    </div>
    `;
    $("#thong_tin_tran_dau").html(thong_tin);
