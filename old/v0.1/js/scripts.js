...
function FixDapAnMobile() {
    $("#fix_mobile").html(`
        <p id="dap_an1" class="small khung-trac-nghiem py-2 px-3"></p>
            <p id="dap_an2" class="small khung-trac-nghiem py-2 px-3"></p>
            <p id="dap_an3" class="small khung-trac-nghiem py-2 px-3"></p>
            <p id="dap_an4" class="small khung-trac-nghiem py-2 px-3"></p>
        `);
}
...
function KetQua() {
    ...
    for (let i = 0; i < 10; i++) {
        ...
        <div id="ket_qua`+ (i + 1) + `" class="` + kt_dung_sai + ` khung-ket-qua d-flex align-items-center">
                    ...
                    <p class="small mx-auto my-auto">` + ds_anime_cau_hoi[i].attributes.canonicalTitle + `</p>
        </div>
        `;
    }
